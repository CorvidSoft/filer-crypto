...
let targets: [Target] =
    ...
    : [
        .binaryTarget(
            ...
            url:
                "https://github.com/CorvidSoft/filer-crypto/releases/download/v0.1.1/FilerCryptoFFI.xcframework.zip",
            checksum: "0aede60ddf17ed667c550a0b64654782ea5f295b06963d73b7b07159339757dc"
        ),
        .target(
            name: "FilerCrypto",
